...
private static WebElement element = null;
	...
	public static WebElement GetSigningSuccessMsg(WebDriver driver)
	{
		...
		element =driver.findElement(By.xpath("//div[@class='row greenBox clsRow divMsg']/div"));
		return element;
	}
	...
	//	element =driver.findElement(By.xpath("//div[@class='row col-md-12 blueBox clsRow divMsg']/div"));
		element =driver.findElement(By.xpath("//div[@class='row blueBox clsRow divMsg']/div"));
		return element;
	}
}
