...
public class CreateTicketTypeBOCA {
	...
	public static WebDriver driver=null;
	  ...
	  public static void CreateTicketType()throws Exception
	  {
		  ...
		  Thread.sleep(3000);
		  RegisterManagementDashboardPageElements.SelectOptionFromSelectOptionDD(driver, CreateTicketTemplate_BOCA_Test.TicketTemplateName).click();
