...
public class WaterfallBookingWithDiscountTest {
	...
	public static WebDriver driver=null;
	  ...
	  public static void CreateMultipleBookings() throws Exception
	  {
		  for (int i=0;i<2;i++)
		  {
			  if(i==0)
			  {
				  time=CreateWaterfallPackageTest.WaterfallAssignmentTime1;
				  BookedQuantity=30;
			  ...
			  {
				  time=CreateWaterfallPackageTest.WaterfallAssignmentTime2;
				  BookedQuantity=31;
				  ExpTotalSpotsLeft = TotalSpots-BookedQuantity;
			...
			//	BookingDashboardPageElements.SelectCategory(driver, "TestCategory_1536556572448");
				...
				BookingDashboardPageElements.Get_BookingDataTab_HeightField(driver).sendKeys("123");
	  ...
	  public static void PayDepoistOnly() throws Exception
		...
		public static void VerifyBalanceDueOnPaymentTab() throws InterruptedException
		{
			...
			assertEquals(Double.valueOf(getElementTextWithout$Sign(str)), GrandTotal-AmountPaid);
			Double.valueOf(getElementTextWithout$Sign(str));
		...
		public static void VerifyWaterfallItems()
		{
			String ExpString="";
			String ActString=BookingDashboardPageElements.Get_BookingDataTab_WaterfallProductText(driver).getText();
			assertEquals(ActString, ExpString);
			ActString=BookingDashboardPageElements.Get_BookingDataTab_WaterfallAssignmentText(driver).getText();
			assertEquals(ActString, ExpString);
		}
