...
public class AddBookingWithTicketTemplateTest {
	...
	public static WebDriver driver=null;
	  ...
	  public static void PayDepoistOnly() throws Exception
	  {
		...
		public static void VerifyTicketsOnTicketTab() throws InterruptedException
		{
			
			Thread.sleep(5000);
			BookingDashboardPageElements.GetTicketsTab(driver).click();
			Thread.sleep(5000);
			int TicketRowCount = BookingDashboardPageElements.Get_TicketsTab_TicketsTableRows(driver);
			assertEquals(TicketRowCount, BookedQuantity);
