...
public class CreateMembershipPackageWithMultipleTaxRatesTest extends TestSetup {
	...
	public static void createMembershipPackage()throws Exception
	{
		...
		Thread.sleep(2000);
		AddMembershipPackageDialogBoxElements.setTaxOption(driver, CreateMultipleTaxTest.TaxOptionName1).click();
		Thread.sleep(2000);
		AddMembershipPackageDialogBoxElements.getTaxOption(driver).click();
		Thread.sleep(2000);
		AddMembershipPackageDialogBoxElements.setTaxOption(driver, CreateMultipleTaxTest.TaxOptionName2).click();
		Thread.sleep(2000);
