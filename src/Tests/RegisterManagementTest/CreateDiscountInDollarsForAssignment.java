...
public class CreateDiscountInDollarsForAssignment {
	...
	public static void createDiscountRule()throws Exception
	{
			...
			Thread.sleep(2000);
			AddDiscountRuleDialogBoxElements.setDiscount(driver).sendKeys(discount);
			Thread.sleep(2000);
	...
	public static void createDiscountPackage()throws Exception
	{
			...
			Thread.sleep(2000);
			 ...
			 discountCode="DiscountCode"+System.currentTimeMillis();
			...
			Thread.sleep(3000);
			CommonFunctions.DiscountCode=discountCode;
