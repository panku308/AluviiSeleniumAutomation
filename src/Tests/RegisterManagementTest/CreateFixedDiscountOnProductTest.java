...
public class CreateFixedDiscountOnProductTest extends TestSetup {
	...
	public static void createDiscountRule()throws Exception
	{
		...
		Thread.sleep(2000);
		AddDiscountRuleDialogBoxElements.getDiscountField(driver, "In Dollars").sendKeys(Keys.chord(Keys.CONTROL, "a"));
		Thread.sleep(2000);
		AddDiscountRuleDialogBoxElements.setDiscount(driver, "In Dollars").sendKeys(discountAmt);
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		AddDiscountRuleDialogBoxElements.getProductNameFilteredValue(driver).click();
		Thread.sleep(3000);
