...
public static String PriceRule_TypeBasePrice="";
	...
	public static void createPriceRule_TypeBasePrice()throws Exception
	{
			...
			Thread.sleep(2000);
			AddPriceRuleDialogBoxElements.getBaseAmount(driver).sendKeys(Keys.BACK_SPACE);
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			AddPriceRuleDialogBoxElements.getUpperLimit(driver).sendKeys(Keys.BACK_SPACE);
			Thread.sleep(2000);
			...
			AddPriceRuleDialogBoxElements.getLowerLimit2(driver).sendKeys(Keys.BACK_SPACE);
			Thread.sleep(2000);
			AddPriceRuleDialogBoxElements.setLowerLimit2(driver).sendKeys("31");
			Thread.sleep(2000);
			AddPriceRuleDialogBoxElements.getUpperLimit2(driver).sendKeys(Keys.BACK_SPACE);
			Thread.sleep(2000);
			AddPriceRuleDialogBoxElements.setUpperLimit2(driver).sendKeys("40");
			Thread.sleep(2000);
			AddPriceRuleDialogBoxElements.getVariableAmount2(driver).sendKeys(Keys.BACK_SPACE);
			Thread.sleep(2000);
